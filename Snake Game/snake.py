...
snake_speed = int(input("Enter a number: "))
...
# Initialising pygame
error_handle=pygame.init()
if error_handle[1] > 0:
    print(f'[!] Had {error_handle[1]} errors when initialising game, exiting...')
    sys.exit(-1)
else:
...
pygame.display.set_caption('LHD snake game')
...
def show_score(choice, color, font, size):
    ...
    # displaying text
    #game_window.blit(bg, (score_surface, score_rect))
